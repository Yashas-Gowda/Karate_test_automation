Feature: PHONE_BASIC SIMTYPE SUBPACKAGE indosat_prepaid Data Partner automation via DPI DEX call
  ...
  Scenario:PHONE_BASIC SIMTYPE SUBPACKAGE indosat_prepaid Data Partner automation via DPI DEX call
