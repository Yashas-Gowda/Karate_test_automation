...
Feature: PHONE_SOCIAL FIDO_phone_socail Data Partner automation via DPI monnai.DEX call
  ...
  Scenario Outline: PHONE_SOCIAL FIDO_phone_socail Data Partner automation via DPI monnai.DEX call - <Scenario>
