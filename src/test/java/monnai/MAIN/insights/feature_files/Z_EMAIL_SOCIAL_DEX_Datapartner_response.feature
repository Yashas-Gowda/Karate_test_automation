...
Feature: EMAIL_SOCAIL FIDO_email_social Data Partner automation via DPI monnai.DEX call
  ...
  Scenario Outline: EMAIL_SOCIAL FIDO_email_social Data Partner automation via DPI monnai.DEX call - <Scenario>
  ...
  Scenario Outline: EMAIL_SOCIAL FIDO_email_social Data Partner automation via DPI monnai.DEX call for validating profile = consumerElectronics   - <Scenario>
    * def dexUrl = requestUrl + '/api/exchange/01H72X88KKK3R5013F54H5P09T'
    Given url dexUrl
  ...
  Scenario Outline: EMAIL_SOCIAL FIDO_email_social Data Partner automation via DPI monnai.DEX call for validating profile = emailProvider   - <Scenario>
    * def dexUrl = requestUrl + '/api/exchange/01H72X88KKK3R5013F54H5P09T'
    Given url dexUrl
  ...
  Scenario Outline: EMAIL_SOCIAL FIDO_email_social Data Partner automation via DPI monnai.DEX call for validating profile = ecommerce   - <Scenario>
    * def dexUrl = requestUrl + '/api/exchange/01H72X88KKK3R5013F54H5P09T'
    Given url dexUrl
  ...
  Scenario Outline: EMAIL_SOCIAL FIDO_email_social Data Partner automation via DPI monnai.DEX call for validating profile = socialMedia   - <Scenario>
    * def dexUrl = requestUrl + '/api/exchange/01H72X88KKK3R5013F54H5P09T'
    Given url dexUrl
  ...
  Scenario Outline: EMAIL_SOCIAL FIDO_email_social Data Partner automation via DPI monnai.DEX call for validating profile = messaging   - <Scenario>
    * def dexUrl = requestUrl + '/api/exchange/01H72X88KKK3R5013F54H5P09T'
    Given url dexUrl
  ...
  Scenario Outline: EMAIL_SOCIAL FIDO_email_social Data Partner automation via DPI monnai.DEX call for validating profile = professional   - <Scenario>
    * def dexUrl = requestUrl + '/api/exchange/01H72X88KKK3R5013F54H5P09T'
    Given url dexUrl
  ...
  Scenario Outline: EMAIL_SOCIAL FIDO_email_social Data Partner automation via DPI monnai.DEX call for validating profile = entertainment   - <Scenario>
    * def dexUrl = requestUrl + '/api/exchange/01H72X88KKK3R5013F54H5P09T'
    Given url dexUrl
  ...
  Scenario Outline: EMAIL_SOCIAL FIDO_email_social Data Partner automation via DPI monnai.DEX call for validating profile = travel   - <Scenario>
    * def dexUrl = requestUrl + '/api/exchange/01H72X88KKK3R5013F54H5P09T'
    Given url dexUrl
  ...
  Scenario Outline: EMAIL_SOCIAL FIDO_email_social Data Partner automation via DPI monnai.DEX call for validating profile = financial   - <Scenario>
    * def dexUrl = requestUrl + '/api/exchange/01H72X88KKK3R5013F54H5P09T'
    Given url dexUrl
  ...
  #  Scenario Outline: PHONE_SOCIAL FIDO_phone_social Data Partner automation via DPI monnai.DEX call
