...
Feature: Testing of DPI  - BUSINESS_REGISTRATION feature scenarios
  ...
  #    Given url requestUrl
  #    And def payload = read( "../" + source + "/BUSINESS_REGISTRATION/Mock/<Scenario>.json")
  #    And headers headers
  #    # mock
  ...
  #      | BUSINESS_REGISTRATION_mock_response_S5103_when_dp_befisc_gives_souce_down   | 200        |
  #      | BUSINESS_REGISTRATION_mock_packageDetails_S2101_dp_response_No_record_found | 200        |
