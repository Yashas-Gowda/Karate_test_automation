Feature: PHONE_BASIC PHONE_STATUS SUBPACKAGE indosat_deactivation_phoneNumberRecycled Data Partner automation via DPI monnai.DEX call
  ...
  Scenario:PHONE_BASIC PHONE_STATUS SUBPACKAGE indosat_deactivation_phoneNumberRecycled Data Partner automation via DPI monnai.DEX call
