Feature: PHONE_BASIC TOP_UP_HISTORY SUBPACKAGE izidata_phone_topUpBehavior Data Partner automation via DPI monnai.DEX call
  ...
  Scenario: PHONE_BASIC TOP_UP_HISTORY SUBPACKAGE izidata_phone_topUpBehavior Data Partner automation via DPI monnai.DEX call
