Feature: IP_BASIC IP QUALITY SCORE Data Partner automation via DPI monnai.DEX call
  ...
  Scenario:IP_BASIC IP QUALITY SCORE Data Partner automation via DPI monnai.DEX call
