...
Feature: Testing of DPI  - DOMAIN_BREACH Package scenarios
  ...
  Scenario Outline:  DPI DOMAIN_BREACH Package positive scenario where type = BREACH_HISTORY_RECORDS  - sanity :- <Scenario>
    Given url requestUrl
    And def payload = read("data/" + source + "/DOMAIN_BREACH/<Scenario>.json")
    And headers headers
    And header Authorization = BearerToken
  ...
  Scenario Outline:  DPI DOMAIN_BREACH Package Negative scenario for validation of  type - sanity :- <Scenario>
    Given url requestUrl
    And def payload = read("data/" + source + "/DOMAIN_BREACH/<Scenario>.json")
    And headers headers
    And header Authorization = BearerToken
