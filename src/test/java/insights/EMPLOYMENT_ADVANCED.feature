...
#  (Manual sign off given by Anjan)
  ...
  Scenario Outline: Validate DPI EMPLOYMENT_ADVANCED positive scenario  <Scenario>
    ...
    * print 'Actual Response---->',karate.pretty(response)
    Then match $.data.employment.advanced.summary contains payload.response.data.employment.advanced.summary
    Then match $.data.employment.advanced.employmentHistory contains payload.response.data.employment.advanced.employmentHistory
    Then match $.data.employment.advanced.pfFilingDetails contains payload.response.data.employment.advanced.pfFilingDetails
  ...
  Scenario Outline: Validate DPI EMPLOYMENT_ADVANCED positive scenario  <Scenario>
    ...
    * print 'Actual Response---->',karate.pretty(response)
    ...
    Examples:
      | Scenario                                                   | statusCode |
    # Bug https://monnai.atlassian.net/browse/MB-3786  | EMPLOYMENT_ADVANCED_is_null_when_no_record_found_in_dp     |                  | 200        |
      | EMPLOYMENT_ADVANCED_summary_isEmployed_false_noOfPfAccounts_1 | 200        |
      | EMPLOYMENT_ADVANCED_summary_isEmployed_true_noOfPfAccounts_2  | 200        |
      | EMPLOYMENT_ADVANCED_summary_isEmployed_false_noOfPfAccounts_2 | 200        |
  ...
  Scenario Outline: Validate DPI EMPLOYMENT_BASIC positive scenario when "phoneDefaultCountryCode" other than IN <Scenario>
    ...
    * print 'Actual Response---->',karate.pretty(response)
    ...
    Examples:
      | Scenario                                                            | statusCode |
#CR      | EMPLOYMENT_ADVANCED_when_request_phoneDefaultCountryCode_other_then_IN | 501        |
  ...
  # cloud watch traces -start
    ...
    * print 'Actual Response---->',karate.pretty(response)
    ...
    Examples:
      ...
      | EMPLOYMENT_ADVANCED_Negative_scenarios_when_both_phone_email_key_is_missing                 | 400        |
      | EMPLOYMENT_ADVANCED_Negative_scenarios_when_both_phone_email_key_is_null                    | 400        |
      | EMPLOYMENT_ADVANCED_Negative_scenarios_when_both_phone_email_key_is_empty_string            | 400        |
      | EMPLOYMENT_ADVANCED_Negative_scenarios_when_both_phone_email_key_is_single_space_string     | 400        |
