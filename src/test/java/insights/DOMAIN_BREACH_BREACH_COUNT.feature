...
Feature: Testing of DPI  - DOMAIN_BREACH Package scenarios
  ...
  Scenario Outline:  DPI DOMAIN_BREACH Package positive scenario where type = BREACH_COUNT  - sanity :- <Scenario>
    Given url requestUrl
    And def payload = read("data/" + source + "/DOMAIN_BREACH/<Scenario>.json")
    And headers headers
  ...
  Scenario Outline:  DPI DOMAIN_BREACH Package Negative scenario where type = BREACH_COUNT for validation of domainName,fromDate,toDate :- <Scenario>
    ...
    * match $.errors contains only deep payload.response.errors
    ...
    Examples:
      ...
      # https://monnai.atlassian.net/browse/MB-4995     | DOMAIN_BREACH_Negative_scenarios_When_type_is_BREACH_COUNT_then_fromDate_toDate_data_Point_key_is_missing                      | 400        |
      ...
      # https://monnai.atlassian.net/browse/MB-4995     | DOMAIN_BREACH_Negative_scenarios_When_type_is_BREACH_COUNT_then_fromDate_toDate_data_Point_key_value_is_empty_string                | 400        |
      # https://monnai.atlassian.net/browse/MB-4995     | DOMAIN_BREACH_Negative_scenarios_When_type_is_BREACH_COUNT_then_fromDate_toDate_data_Point_key_value_is_empty_string_with_space     | 400        |
      # https://monnai.atlassian.net/browse/MB-4995     | DOMAIN_BREACH_Negative_scenarios_When_type_is_BREACH_COUNT_then_fromDate_toDate_data_Point_key_value_is_null                        | 400        |
  ...
  #
  #
  #      | DOMAIN_BREACH_Negative_scenarios_When_type_is_BREACH_HISTORY_RECORDS_then_Optional_cursor_data_Point_key_value_is_invalid_syntax_format  | 400        |
  #      | DOMAIN_BREACH_Negative_scenarios_When_type_is_BREACH_HISTORY_RECORDS_then_Optional_cursor_data_Point_key_value_is_invalid_abc            | 400        |
  #      | DOMAIN_BREACH_Negative_scenarios_When_type_is_BREACH_HISTORY_RECORDS_then_Optional_cursor_data_Point_key_value_is_invalid_123            | 400        |
  #
  #      |  DOMAIN_BREACH_Negative_scenarios_When_type_is_BREACH_HISTORY_RECORDS_then_Optional_cursor_data_Point_key_value_is_number                | 400        |
  #      |  DOMAIN_BREACH_Negative_scenarios_When_type_is_BREACH_HISTORY_RECORDS_then_Optional_cursor_data_Point_key_value_is_boolean               | 400        |
