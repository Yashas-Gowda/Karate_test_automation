Feature: PHONE_BASIC PHONE_TENURE SUBPACKAGE indosat_tenure Data Partner automation via DPI monnai.DEX call
  ...
  Scenario: PHONE_BASIC PHONE_TENURE SUBPACKAGE indosat_tenure Data Partner automation via DPI monnai.DEX call
