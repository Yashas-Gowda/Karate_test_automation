...
Feature: EMAIL_BASIC FIDO_email_basic Data Partner automation via DPI monnai.DEX call
  ...
  Scenario Outline: EMAIL_BASIC FIDO_email_basic Data Partner automation via DPI monnai.DEX call - <Scenario>
  ...
  #  Scenario Outline: EMAIL_SOCIAL FIDO_email_social Data Partner automation via DPI monnai.DEX call
